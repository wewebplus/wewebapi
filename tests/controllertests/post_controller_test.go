...
func TestCreatePost(t *testing.T) {
	...
	token, err := server.SignIn(user.SyStfEmail, "password") //Note the password in the database is already hashed, we want unhashed
	if err != nil {
